              ...
              {[
                ...
                return (
                  <button
                    ...
                    className={`flex items-center gap-3 py-3 px-4 rounded-xl font-medium text-sm transition-all w-full text-left ${isActive
                                ...
                                <div className="flex items-start gap-3 min-w-0">
                                  ...
                                  <div className="min-w-0">
                                    <div className="flex flex-wrap items-center gap-2">
                                      ...
                                      <span className={`text-[10px] font-extrabold px-2 py-0.5 rounded-full ${hosp.type === 'Government'
                        ...
                        {[
                          ...
                          return (
                            <button
                              ...
                              className={`px-4 py-2 rounded-full text-xs font-bold border transition-all ${isSelected
                      ...
                      {['Headache', 'Fever', 'Cough', 'Cold', 'Body Ache', 'Nausea', 'Fatigue', 'Back Pain'].map((chip) => {
                        ...
                        return (
                          <button
                            ...
                            className={`px-4 py-2 rounded-full text-sm font-bold transition-all duration-200 border ${isSelected
                  ...
                  <div className="bg-white dark:bg-slate-800 border border-indigo-100 dark:border-slate-700 rounded-2xl p-6 shadow-sm space-y-6">
                        ...
                        {[
                          ...
                          return (
                            <button
                              ...
                              className={`flex-1 py-2 px-3 rounded-full text-xs font-bold border transition-all text-center ${isActive
                    ...
                    <div className="flex flex-col sm:flex-row items-center justify-center gap-4 pt-2">
                      ...
                      <button
                        ...
                        className={`px-4 py-3 rounded-xl border text-xs font-black transition-all flex items-center justify-center shrink-0 w-full sm:w-16 ${suggesterLang === 'HI'
                      ...
                      {!suggestionsLoading && suggestionsResult && (
                        <div className="space-y-4">
                          ...
                          <div id="medicine-report" className="space-y-4 bg-white dark:bg-slate-900 p-2 rounded-2xl">
                            ...
                            <div className={`p-6 border border-l-4 rounded-2xl transition-all shadow-sm ${suggestionsResult.system === 'Ayurvedic'
                              ...
                              <div className="flex items-start gap-4">
                                <div className={`w-11 h-11 rounded-xl flex items-center justify-center shrink-0 shadow-sm ${suggestionsResult.system === 'Ayurvedic'
                            ...
                            {suggestionsResult.suggestions && suggestionsResult.suggestions.length > 0 ? (
                              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                {suggestionsResult.suggestions.map((sug, idx) => (
                                  <div
                                    key={idx}
                                    className={`p-6 bg-slate-50 dark:bg-slate-900 border border-l-4 rounded-2xl flex flex-col justify-between shadow-sm ${suggestionsResult.system === 'Ayurvedic'
                                  ...
                                  >
                                    <div className="space-y-1.5">
                                      <h4 className={`font-display font-semibold text-sm ${suggestionsResult.system === 'Ayurvedic'
                                    ...
                                    <div className="mt-3 pt-2.5 border-t border-slate-200/50 dark:border-slate-800/50 flex items-center gap-1.5 text-[11px] text-slate-400 font-bold uppercase">
                                      <Clock className={`w-3.5 h-3.5 shrink-0 ${suggestionsResult.system === 'Ayurvedic'
                                          ? 'text-green-500'
                                          : suggestionsResult.system === 'Homeopathy'
                                            ? 'text-amber-500'
                                            : 'text-blue-500'
